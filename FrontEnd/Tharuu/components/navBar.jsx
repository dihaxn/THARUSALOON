...
const Navbar = ({ user = null }) => {
    // Redux removed: keep a simple navigation bar that links to routes
        ...
        <div className="navbar">
                <nav className="bg-white border-gray-200 dark:bg-gray-900">
                    ...
                    <div className="flex md:order-2">
                        <Link to="/login" className="text-white bg-blue-600 hover:bg-blue-700 px-2 py-2 rounded-full">Login</Link>

        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="email" defaultValue={user?.email || 'customer@tharubridal.lk'} className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-100 focus:border-pink-400" />
            </div>
            <div>

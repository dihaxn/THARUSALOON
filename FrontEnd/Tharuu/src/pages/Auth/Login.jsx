  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#FFF9F9]">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-16">
        <div className="grid w-full max-w-5xl gap-12 rounded-3xl bg-white/85 p-12 shadow-2xl shadow-pink-100 lg:grid-cols-[1.15fr,1fr]">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-600">
              Access your bookings, explore couture collections, and chat with our stylists. We&apos;re dedicated to crafting unforgettable wedding experiences just for you.
            </p>
            <div className="space-y-4 rounded-2xl border border-pink-100 bg-white/75 p-6 text-sm text-slate-600">
              <p className="font-semibold text-pink-500">Need an account?</p>
              <p>
                Create a profile to unlock personalized gown curation, appointment management, and priority consultation with our lead stylist.
              </p>
              <a
                className="inline-flex w-fit items-center justify-center rounded-full bg-pink-500 px-5 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white shadow-md shadow-pink-200 transition hover:bg-pink-600"
                href="/register"
              >
                Create an account
              </a>
          ...
          <div className="rounded-2xl border border-pink-100 bg-white/85 p-8 shadow-xl shadow-pink-100">

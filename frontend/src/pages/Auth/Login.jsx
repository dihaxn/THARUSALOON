      ...
      <main className="flex flex-1 items-center justify-center px-4 py-8">
        <div className="grid w-full max-w-3xl gap-6 rounded-2xl bg-white/85 p-6 shadow-xl shadow-pink-100 lg:grid-cols-[1fr,1fr]">
          <div className="space-y-4">
            <span className="inline-flex rounded-full bg-pink-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-pink-600"> Welcome back </span>
            <h1 className="font-serif text-3xl font-semibold text-slate-900"> Your bridal journey starts here </h1>
            <p className="text-sm leading-relaxed text-slate-600"> Access your bookings, explore couture collections, and chat with our stylists. </p>
            <div className="space-y-3 rounded-xl border border-pink-100 bg-white/75 p-4 text-sm text-slate-600">
              ...
              <p> Create a customer account to book appointments and access our services. </p>
              <a className="inline-flex w-fit items-center justify-center rounded-full bg-pink-500 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white shadow-md shadow-pink-200 transition hover:bg-pink-600" href="/register" >
              ...
              {({ errors, touched }) => (
                <Form className="space-y-4">
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-500">
                    ...
                    <a className="font-semibold text-pink-500 hover:text-pink-600" href="/forgot-password"> Forgot password? </a>
                  </div>
                  ...
                  <p className="text-center text-xs text-slate-500"> New to Tharu Bridal Studio?{' '} <a className="font-semibold text-pink-500 hover:text-pink-600" href="/register"> Create your profile </a> </p>
                </Form>
              )}
            </Formik>
          </div>
